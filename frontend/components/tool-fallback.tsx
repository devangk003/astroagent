...
function ToolFallbackArgs({
  ...
  return (
    <div
      ...
      {...props}
    >
      <pre className="aui-tool-fallback-args-value min-w-0 whitespace-pre-wrap break-words">
        {argsText}
      </pre>
    </div>
  );
...
function ToolFallbackResult({
  ...
  return (
    ...
    >
      ...
      <pre className="aui-tool-fallback-result-content min-w-0 whitespace-pre-wrap break-words">
